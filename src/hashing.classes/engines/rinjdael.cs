...
namespace hashing.classes
{
     ...
     * 
     * @see https://msdn.microsoft.com/en-us/library/system.security.cryptography.rijndaelmanaged(v=vs.110).aspx
     * @see https://msdn.microsoft.com/en-us/library/system.security.cryptography.rijndael(v=vs.110).aspx
     */
    internal class rinjdael : encoder
    {
        ...
        private rinjdael() { }
        public rinjdael(string password)
        {
